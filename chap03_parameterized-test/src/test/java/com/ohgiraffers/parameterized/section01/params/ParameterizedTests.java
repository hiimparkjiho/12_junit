...
class ParameterizedTests {
    /*
    * 테스트 시 여러 값들을 검증을 해야하는 모든 경우의 수만큼 테스트 메소드를 작성해야 한다.
    ...
    * given then when 패턴에서 사전에 테스트를 위해 준비하던 given 부분을 대체할 수 있게 된다.
    * */
    ...
    * */
    ...
    @ParameterizedTest  // 테스트 과정 중 given 부분을 대신할 수 있다.
