...
public class AdditionalAnnotationTests {
    ...
    * */
    ...
    // editConfiguration에서 add new configuration에서 따로 지정해서 이것만 따로 테스트 할 수 있다(@Tag 어노테이션은 특정한 메소드만 테스트만 할 경우에 사용한다 Tag에 연산자를 사용하면 여러개를 할 수 있다.)
    @Test
    @Tag("production")
